...
RUN wget -O plugins/mirai-api-http-v2.5.0.mirai.jar https://github.com/project-mirai/mirai-api-http/releases/download/v2.5.0/mirai-api-http-v2.5.0.mirai.jar
